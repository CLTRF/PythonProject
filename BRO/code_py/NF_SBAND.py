...
def _NOISE_FIGURE_MEASURMENTS_X_BAND2(_str_freq_MHz, _stop_freq_MHz, _IF_BW_MHz, _Nb_Points_Sc, _ENR_dB, _frequency_MHz, _span_MHz, _LNA_no, _LNA_serial_number):
